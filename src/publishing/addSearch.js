...
// // Define the transformLabel function here
...
//   //   console.log("CF CHECK")
//   //   e.preventDefault();
  
//   //   try {
//   //     const combinedFictionGenresMust = [
//   //       ...formState.fiction_genre_must,
//   //       ...formState.fiction_specific_genre_must,
//   //     ];

//   //     console.log("CF", formState)
//   //     const combinedFictionGenresCan = [
//   //       ...formState.fiction_genre_can,
//   //       ...formState.fiction_specific_genre_can,
//   //     ];

//   //     console.log("CF1", formState)

//   //     const combinedFictionGenresExclude = [
//   //       ...formState.fiction_genre_exclude,
//   //       ...formState.fiction_specific_genre_exclude,
//   //     ];
//   //     console.log("CF2", formState)

//   //     const combinedNonFictionGenresMust = [
//   //       ...formState.non_fiction_genre_must,
//   //       ...formState.non_fiction_specific_genre_must,
//   //     ];

//   //     console.log("CF3", formState)

//   //     const combinedNonFictionGenresCan = [
//   //       ...formState.non_fiction_genre_can,
//   //       ...formState.non_fiction_specific_genre_can,
//   //     ];

//   //     console.log("CF4", formState)

//   //     const combinedNonFictionGenresExclude = [
//   //       ...formState.non_fiction_genre_exclude,
//   //       ...formState.non_fiction_specific_genre_exclude,
//   //     ];
...
//     try {
//         // Function to convert JavaScript arrays to PostgreSQL array format
//         const formatArrayForPostgres = (array) => {
//             return array.length ? `{${array.map(item => `"${item}"`).join(',')}}` : '{}';
//         };

//         // Construct the search payload, ensuring that only non-empty arrays are sent
//         const searchPayload = {
...
//         // Insert the search criteria into the pub_searches table and get the ID
