// /Users/katiebrown/site-for-novels/src/authors/Sidebar.js

import React from 'react';
import { Drawer, List, ListItem, ListItemText } from '@mui/material';
import { useNavigate } from 'react-router-dom'; // Import useNavigate from react-router-dom

const Sidebar = ({ onAddProjectClick }) => {
  const drawerWidth = '25vw'; // 1/4 of the screen width
  const navigate = useNavigate(); // Hook for navigation

  const menuItems = [
    { text: 'Dashboard', path: '/authors/Dashboard' },
    { text: 'Profile', path: '/authors/AuthorProfile' },
    { text: 'Add Project', action: onAddProjectClick },
    { text: 'Purchase Critique', path: null, disabled: true }, // Example of a disabled item
